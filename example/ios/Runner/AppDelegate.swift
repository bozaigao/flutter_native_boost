...
@objc class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(
        ...
        Container.default.startFlutterEngine(navigatorDelegate: self, httpProvider: nil, commonHandler: self.handle(_:_:_:), automaticallyRegisterPlugins: true)
        
        return true
    }
}

extension AppDelegate: ContainerNavigationDelegate {
    ...
    func push(_ name: String, arguments: Any?, options: Options, callback token: CallbackToken) {
        ...
        switch name {
            ...
            default:
                vc = options.isFlutterRoute ? ContainerFlutterViewController(name, arguments: arguments) : Flutter2NativeViewController()
        }
...
extension FlutterPage {
    ...
    func flutterViewController(callback: @escaping (Any?) -> Void) -> UIViewController {
        return ContainerFlutterViewController(name, arguments: arguments, callback: callback)
    }
}


extension AppDelegate: ContainerCommonHandler {
