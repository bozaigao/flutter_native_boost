...
class S {
  ...
  static final JSON _localizedValues = JSON({
    'en': {
      'home': {
        'title': 'flutter_native_boost Features Demo',
        'tip1': 'All flutter page has flutter_native_boost banner on rightTop',
    ...
    'zh': {
      ...
      'basic': {
        'title': '基础(Basic)',
        'description': '集成flutter_native_boost的基础功能',
